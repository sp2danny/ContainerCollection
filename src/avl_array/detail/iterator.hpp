...
public: // -------------- PUBLIC INTERFACE ----------------
  ...
  explicit avl_array_iterator(const my_reverse &it); // From reverse
  ...
  difference_type
  operator-(const avl_array_iterator<T, A, W, P, X, Y> &it) const;

  // Equality comparisons: O(1)

  template <class X, class Y>
  bool operator==(const avl_array_iterator<T, A, W, P, X, Y> &it) const;
...
inline avl_array_iterator<T, A, W, P, Ref, Ptr>::avl_array_iterator()
    : ptr(NULL) {}
...
operator typename avl_array_iterator<T, A, W, P, Ref, Ptr>::const_iterator() {
...
template <class T, class A, class W, class P, class Ref, class Ptr>
inline typename avl_array_iterator<T, A, W, P, Ref, Ptr>::reference
avl_array_iterator<T, A, W, P, Ref, Ptr>::
operator()(typename avl_array_iterator<T, A, W, P, Ref, Ptr>::difference_type n)
    const {
  return *(*this + n);
}
...
template <class T, class A, class W, class P, class Ref, class Ptr>
inline avl_array_iterator<T, A, W, P, Ref, Ptr>
avl_array_iterator<T, A, W, P, Ref, Ptr>::operator+(difference_type n) const {
  my_class tmp(*this);
...
template <class T, class A, class W, class P, class Ref, class Ptr>
inline avl_array_iterator<T, A, W, P, Ref, Ptr> &
avl_array_iterator<T, A, W, P, Ref, Ptr>::operator+=(difference_type n) {
  *this = *this + n;
  return *this;
}
...
template <class T, class A, class W, class P, class Ref, class Ptr>
template <class X, class Y>
inline typename avl_array_iterator<T, A, W, P, Ref, Ptr>::difference_type
avl_array_iterator<T, A, W, P, Ref, Ptr>::
operator-(const avl_array_iterator<T, A, W, P, X, Y> &it) const {
  my_array *a, *b;
  size_type m, n;
...
template <class T, class A, class W, class P, class Ref, class Ptr>
template <class X, class Y>
inline bool avl_array_iterator<T, A, W, P, Ref, Ptr>::
operator==(const avl_array_iterator<T, A, W, P, X, Y> &it) const {
...
template <class T, class A, class W, class P, class Ref, class Ptr>
inline typename avl_array_iterator<T, A, W, P, Ref, Ptr>::iterator_category
iterator_category(const avl_array_iterator<T, A, W, P, Ref, Ptr> &) {
  return typename avl_array_iterator<T, A, W, P, Ref, Ptr>::iterator_category();
}

// Iterator tag function value_type()

template <class T, class A, class W, class P, class Ref, class Ptr>
inline typename avl_array_iterator<T, A, W, P, Ref, Ptr>::value_type *
value_type(const avl_array_iterator<T, A, W, P, Ref, Ptr> &) {
  return reinterpret_cast<
      typename avl_array_iterator<T, A, W, P, Ref, Ptr>::value_type *>(0);
}
...
distance_type(const avl_array_iterator<T, A, W, P, Ref, Ptr> &) {
  return reinterpret_cast<
      typename avl_array_iterator<T, A, W, P, Ref, Ptr>::difference_type *>(0);
}
