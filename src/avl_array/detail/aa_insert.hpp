...
inline typename avl_array<T, A, W, P>::iterator // Insert anywhere
...
template <class T, class A, class W, class P>
inline typename avl_array<T, A, W, P>::iterator avl_array<T, A, W, P>::insert(
...
template <class T, class A, class W, class P>
inline void avl_array<T, A, W, P>::insert(
    const typename avl_array<T, A, W, P>::iterator &it, // Where
    int n,                                              // How many
    typename avl_array<T, A, W, P>::const_reference t)  // Original
{
...
template <class T, class A, class W, class P>
// not inline
void avl_array<T, A, W, P>::insert_before(
...
template <class T, class A, class W, class P>
// not inline
void avl_array<T, A, W, P>::insert_anywhere(
    typename avl_array<T, A, W, P>::node_t *newnode) {
  ...
  {                            // tree chosing allways the less
    ...
    while (p->m_children[L] && p->m_children[R])
      p = p->m_children[L]->m_count <= p->m_children[R]->m_count
              ? p->m_children[L]
              : p->m_children[R];
  }
