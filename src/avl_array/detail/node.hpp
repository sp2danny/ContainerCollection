...
class avl_array_node_tree_fields { // Note that the dummy has no T
...
inline void
avl_array_node_tree_fields<T, A, W, P>::init() // Write default values
{
  m_parent = m_children[L] = m_children[R] = NULL; // No relatives
...
template <class T, class A, class W, class P>
inline avl_array_node_tree_fields<T, A, W, P>::avl_array_node_tree_fields() {
  init();
}
...
template <class T, class A, class W, class P>
inline std::size_t avl_array_node_tree_fields<T, A, W, P>::left_count() const {
  return m_children[L] ? m_children[L]->m_count : 0;
}

template <class T, class A, class W, class P>
inline std::size_t avl_array_node_tree_fields<T, A, W, P>::right_count() const {
  return m_children[R] ? m_children[R]->m_count : 0;
}

template <class T, class A, class W, class P>
inline std::size_t avl_array_node_tree_fields<T, A, W, P>::left_height() const {
  return m_children[L] ? m_children[L]->m_height : 0;
}

template <class T, class A, class W, class P>
inline std::size_t
avl_array_node_tree_fields<T, A, W, P>::right_height() const {
  return m_children[R] ? m_children[R]->m_height : 0;
}

template <class T, class A, class W, class P>
inline W avl_array_node_tree_fields<T, A, W, P>::left_width() const {
  return m_children[L] ? m_children[L]->m_total_width : W(0);
}

template <class T, class A, class W, class P>
inline W avl_array_node_tree_fields<T, A, W, P>::right_width() const {
  return m_children[R] ? m_children[R]->m_total_width : W(0);
}
