...
template <class T, class A, class W, class P> // The only visible class
class avl_array;                              // is avl_array<T,A,W,P>

namespace detail // Private nested namespace mkr::detail
{

template <class T, class A, class W, class P> // Links and counters
class avl_array_node_tree_fields;             // of a tree node

template <class T, class A, class W, class P> // A tree node, including
...
template <class Ptr> class null_data_provider;
...
template <class Ptr> class copy_data_provider;
