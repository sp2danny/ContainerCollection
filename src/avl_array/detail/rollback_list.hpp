...
template <class T, class A, class W, class P> // A list of nodes to
...
inline rollback_list<T, A, W, P>::rollback_list(my_array *owner)
    : m_owner(owner), m_first(NULL), m_last(NULL) {}
...
template <class T, class A, class W, class P>
inline rollback_list<T, A, W, P> &rollback_list<T, A, W, P>::
operator=(const rollback_list<T, A, W, P> &) {}
...
template <class T, class A, class W, class P>
inline void rollback_list<T, A, W, P>::push_front(node_t *newnode) {
...
template <class T, class A, class W, class P>
inline void rollback_list<T, A, W, P>::push_back(node_t *newnode) {
...
template <class T, class A, class W, class P>
inline void rollback_list<T, A, W, P>::commit(node_t *&first, node_t *&last) {
  first = m_first;
  last = m_last;
