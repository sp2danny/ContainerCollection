...
inline typename avl_array<T, A, W, P>::iterator avl_array<T, A, W, P>::begin() {
...
template <class T, class A, class W, class P>
inline typename avl_array<T, A, W, P>::iterator avl_array<T, A, W, P>::end() {
...
template <class T, class A, class W, class P>
inline typename avl_array<T, A, W, P>::const_reverse_iterator
