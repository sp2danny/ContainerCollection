...
template <class T, class A, class W, class P> // Tree node (with payload T)
class avl_array_node : private avl_array_node_tree_fields<T, A, W, P> {
  ...
  typedef typename avl_array<T, A, W, P>::const_reference const_reference;
