...
template <class T, class A, class W, class P>
inline void avl_array<T, A, W, P>::push_front(
...
template <class T, class A, class W, class P>
inline void avl_array<T, A, W, P>::pop_front() {
  erase(begin());
}
...
template <class T, class A, class W, class P>
inline typename avl_array<T, A, W, P>::reference avl_array<T, A, W, P>::back() {
  return *--end();
}
...
template <class T, class A, class W, class P>
inline void avl_array<T, A, W, P>::push_back(
    typename avl_array<T, A, W, P>::const_reference t) {
  insert(end(), t);
}
...
template <class T, class A, class W, class P>
inline void avl_array<T, A, W, P>::pop_back() {
  erase(--end());
}
