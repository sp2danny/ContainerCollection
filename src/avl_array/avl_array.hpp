...
template <class T,                     // The container class
          ...
          class W = empty_number, class P = empty_number>
class avl_array : private avl_array_node_tree_fields<T, A, W, P> {
...
public:
  ...
  typedef avl_array_iterator<T, A, W, P, reference, pointer> iterator;
  typedef avl_array_iterator<T, A, W, P, const_reference, const_pointer>
      const_iterator;
  typedef avl_array_rev_iter<T, A, W, P, reference, pointer> reverse_iterator;
...
private:
  ...
  BOOST_CLASS_REQUIRE(value_type, boost, LessThanComparableConcept);
  ...
  BOOST_CLASS_REQUIRE(value_type, boost, DefaultConstructibleConcept);

  BOOST_CLASS_REQUIRE(allocator_t, boost, DefaultConstructibleConcept);
...
public:
  ...
  template <class IT> avl_array(IT from, IT to);

  template <class IT> avl_array(IT from, size_type n);
  ...
  reverse_iterator insert(const reverse_iterator &it, const_reference t);

  void insert(const iterator it, size_type n, const_reference t);
  void insert(const iterator &it, int n, const_reference t);
  void insert(const iterator &it, long n, const_reference t);
  void insert(const reverse_iterator it, size_type n, const_reference t);
  void insert(const reverse_iterator &it, int n, const_reference t);
  void insert(const reverse_iterator &it, long n, const_reference t);

  template <class IT> void insert(iterator it, IT from, IT to);

  template <class IT> void insert(reverse_iterator it, IT from, IT to);
  ...
  static void move(iterator src_from, size_type n, iterator dst);
  static void move(reverse_iterator src_from, size_type n, iterator dst);
  static void move(iterator src_from, size_type n, reverse_iterator dst);
  static void move(reverse_iterator src_from, size_type n,
                   reverse_iterator dst);

  static void move(iterator src_from, iterator src_to, iterator dst);
  static void move(reverse_iterator src_from, reverse_iterator src_to,
                   iterator dst);
  static void move(iterator src_from, iterator src_to, reverse_iterator dst);
  static void move(reverse_iterator src_from, reverse_iterator src_to,
                   reverse_iterator dst);
  ...
  void splice(iterator dst, my_class &src, iterator src_from);
  void splice(reverse_iterator dst, my_class &src, iterator src_from);
  void splice(iterator dst, my_class &src, reverse_iterator src_from);
  void splice(reverse_iterator dst, my_class &src, reverse_iterator src_from);

  void splice(iterator dst, my_class &src, iterator src_from, iterator src_to);
  void splice(reverse_iterator dst, my_class &src, iterator src_from,
              iterator src_to);
  void splice(iterator dst, my_class &src, reverse_iterator src_from,
  ...
  template <class CMP>
  bool binary_search(const_reference t, const_iterator &it, CMP cmp) const;
  template <class CMP>
  bool binary_search(const_reference t, iterator &it, CMP cmp);
  template <class CMP>
  bool binary_search(const_reference t, const_reverse_iterator &it,
                     CMP cmp) const;
  template <class CMP>
  bool binary_search(const_reference t, reverse_iterator &it, CMP cmp);

  bool binary_search(const_reference t, iterator &it);
  bool binary_search(const_reference t, reverse_iterator &it);
  bool binary_search(const_reference t, const_iterator &it) const;
  bool binary_search(const_reference t, const_reverse_iterator &it) const;

  bool binary_search(const_reference t) const;

  template <class CMP>
  iterator insert_sorted(const_reference t, bool allow_duplicates, CMP cmp);

  iterator insert_sorted(const_reference t, bool allow_duplicates = true);

  template <class CMP> void sort(CMP cmp);

  void sort();

  template <class CMP> void stable_sort(CMP cmp);

  void stable_sort();

  template <class CMP> void merge(my_class &donor, CMP cmp);

  void merge(my_class &donor);

  template <class CMP> void unique(CMP cmp);
  ...
  void npsv_set_width(const iterator &it, W w, bool update_sums = true);
  ...
  template <class CMP> iterator npsv_at_pos(W pos, CMP cmp);

  template <class CMP> const_iterator npsv_at_pos(W pos, CMP cmp) const;

  // ------------------------- FRIENDS ---------------------------

private:
  friend class avl_array_iterator<T, A, W, P, reference, pointer>;
  friend class avl_array_iterator<T, A, W, P, const_reference, const_pointer>;

  friend class avl_array_rev_iter<T, A, W, P, reference, pointer>;
  friend class avl_array_rev_iter<T, A, W, P, const_reference, const_pointer>;
...
private:
  ...
  template <class IT> static node_t *iterator_pointer(const IT &it);
  ...
  template <class IT> IT erase_it(IT it);
  ...
  static size_type position_of_node(const node_t *p, my_class *&a,
                                    bool reverse);

  node_t *node_at_pos(size_type pos) const;

  static node_t *jump(node_t *p, difference_type n, bool reverse);
  ...
  size_type                                      // created
      construct_nodes_list(node_t *&first,       // First and last node of
  ...
  template <class IT>
  static void move_nodes(IT src_from, size_type n, node_t *dst,
                         bool reverse = false);
  ...
  template <class DP> void resize(size_type n, DP &dp);
};
